...
"$cp_binary" "$app_resources/agent-codex-light.svg" "$stage_app/Contents/Resources/agent-codex-light.svg"
"$cp_binary" "$app_resources/agent-opencode.svg" "$stage_app/Contents/Resources/agent-opencode.svg"
"$cp_binary" "$app_resources/agent-opencode-light.svg" "$stage_app/Contents/Resources/agent-opencode-light.svg"
"$cp_binary" "$app_resources/agent-cursor.svg" "$stage_app/Contents/Resources/agent-cursor.svg"
"$cp_binary" "$app_resources/agent-cursor-light.svg" "$stage_app/Contents/Resources/agent-cursor-light.svg"
"$cp_binary" "$app_resources/github.svg" "$stage_app/Contents/Resources/github.svg"
"$cp_binary" "$app_resources/github-light.svg" "$stage_app/Contents/Resources/github-light.svg"
"$cp_binary" "$app_resources/github-star.svg" "$stage_app/Contents/Resources/github-star.svg"
