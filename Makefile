.PHONY: help build adr-check dev-install dev-deploy shim vet test test-all opa-test smoke e2e clean licenses licenses-check sign dist-tarball e2e-release chaos
